...
image_dir = "/home/djw/Fine-grained-erro/checkimg/*.jpg"
xml_dir = "/home/djw/Fine-grained-erro/checkxml/*.xml"
...
for index , image_file in enumerate(images_list):
    ...
    xml_file = image_file.replace("checkimg", "checkxml").replace("jpg", "xml")
